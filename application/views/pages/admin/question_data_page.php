         ...
         <div class="page-header page-header-default">
            <div class="page-header-content">
               <div class="page-title">
                  <h4><i class="icon-safe position-left"></i> <span class="text-semibold">Question Data</span></h4>
               </div>
                     ...
                     <form id="entityForm" action="#" class="form-horizontal">
                        <div class="modal-body">
                          ...
                          <div class="form-group">
                           ...
                           <div class="form-group">
                              <label class="control-label col-sm-3">Question Set <span class="text-danger">*</span> </label>
                              <div class="col-sm-9">
                                 <select id="set_id" class="form-control">
...
function getAll() {
    postBack("administrator/getAllQuestions", "", function(response) {

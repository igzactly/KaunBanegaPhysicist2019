...
function getAll() {
    postBack("administrator/getAllMasterTableQuests", "", function(response) {
        ...
        for (var i = 0; i < output.length; i++) {
            ...
            tableData += "<td class='nameClass'>" + output[i].question + "</td>";
...
function addEntity() {
    ...
    postBack("administrator/addMasterTableQuestion", "postdata=" + postdata, function(response) {
...
function getEntityDetails() {
    ...
    var postdata = JSON.stringify(objArray);
    postBack("administrator/getMasterTableQuestionData", "postdata=" + postdata, function(response) {

        var output = JSON.parse(response);
        //console.log(output);

        $('#nameTb').val(output.question);
...
function updateEntity() {
    ...
    var postdata = JSON.stringify(objArray);
    postBack("administrator/updateMasterTableQuestion", "postdata=" + postdata, function(response) {
        console.log(response);
        var output = JSON.parse(response);
        formSaved();
        if (output.status == true) {
